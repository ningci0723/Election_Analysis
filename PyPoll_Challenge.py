...
file_to_save = os.path.join("/Users/ningci/Desktop/Election_analysis/analysis", "election_results.txt")
...
with open(file_to_save, "w") as txt_file:
    ...
    for candidate_name in candidate_votes:
        ...
        #Determine winning vote count, winning percentageg and candidate
